...
export const editarItem = (elemento, itemData) => {
    ...
    if (novoItem !== null && novoItem.trim() !== "") {
        ...
        itemData.innerText = `*editada ${new Date().toLocaleDateString("pt-BR", { weekday: "long" })} (${new Date().toLocaleDateString()}) às ${new Date().toLocaleTimeString("pt-BR", { hour: "numeric", minute: "numeric"})}`;
